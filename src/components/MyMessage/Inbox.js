            ...
            <TouchableOpacity style={styles.container} onPress={() => this.onPressedItem()}>
              <View style={styles.contentContainer}>
                <View style={{ flexDirection: 'row'}}>
                      <Text numberOfLines={1} style={{ color: Theme.black, fontSize: 18 }}>{this.props.item.sendername} - </Text>
                      <View style={{flex: 1}}>
                        <Text numberOfLines={1} style={{ color: Theme.black, fontSize: 18 }}>{this.props.item.message}</Text>
                      </View>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 3 }}>
                      <Text numberOfLines={1} style={{ color: Theme.black, fontSize: 14 }}>{this.props.item.date} - </Text>
                      <Text numberOfLines={1} style={{ color: Theme.black, fontSize: 14}}>{this.props.item.time}</Text>
                </View>
              </View>
